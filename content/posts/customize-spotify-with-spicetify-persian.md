...
قبل از همه چیز باید class بخشی رو که میخوایم پیدا کنیم. میتونید سرچ کنید و دنبال بگردید یا اطراف اون Element ای که میخواین، راست کلیک کنید و Inspect Element رو بزنید.   
